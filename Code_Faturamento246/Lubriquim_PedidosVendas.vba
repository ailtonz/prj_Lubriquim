...
Private Sub codCliente_Click()
    Me.ICMS = Me.codCliente.Column(2)
...
On Error GoTo Err_cmdVisualizar_Click
    ...
    stDocName = "Lubriquim_PedidosVendas"
    DoCmd.OpenReport stDocName, acPreview, , "Lubriquim_PedidosVendas.codPedidoLubriquim = " & Me.Codigo
